...
function(a) {
    ...
    b(function(a, b) {
        ...
        a.config.menus = [ "bold", "underline", "italic",  "eraser", "forecolor", 'bgcolor', "|",  "fontsize", "unorderlist", "orderlist", 'alignleft','aligncenter', 'alignright', "|", "link", "unlink",  "img", 'emotion', "|", "undo", "redo", "fullscreen","|","source", ],
        a.config.colors = {
            "#880000": "暗红色",
            "#800080": "紫色",
            "#ff0000": "红色",
        ...
        if (window.FileReader && window.FormData) {
            ...
            c.fn.selected = function(c, d) {
                ...
                for (var ii=0;ii<f.length;ii++)
                {
                    ...
                    var file_suffix="";
                    var filename=f[ii].name;                   
                    var index1=filename.lastIndexOf(".");                     
                    var index2=filename.length;  
                    var file_suffix=filename.substring(index1+1,index2);                     
                    var type_allow="jpg,jpeg,png,gif,bmp";                    
                    if(type_allow.indexOf(file_suffix) < 0 ){
                        alert('图片只允许jpg,jpeg,png,gif,bmp格式');
                        return
                    }
                }                             
